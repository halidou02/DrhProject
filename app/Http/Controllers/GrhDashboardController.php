...
class GrhDashboardController extends Controller
{
  public function index()
  {
   ...
   $dureeRecrutement = 30; // A calculer selon vos données
    ...
    return view('content.dashboard.GrhDashboard', compact('effectifTotal', 'TotalDepartement','repartitionGenre', 'repartitionAge', 'repartitionDepartement', 'rotationPersonnel', 'tauxAbsenteisme', 'coutTotal', 'dureeRecrutement'));
  }
}
